...
import com.cetcme.rcldandroidZhejiang. MyClass.NoScrollGridView;
...
public class HomepageFragment extends BaseFragment {
    ...
    private void initNavigationView() {
        NavigationView navigationView = (NavigationView) view.findViewById(R.id.nav_main_in_fragment_homepage);
