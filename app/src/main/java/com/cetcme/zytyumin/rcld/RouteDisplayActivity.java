...
//                    Log.i("Main", convedListString);
    ...
    private void initNavigationView() {
        navigationView = (NavigationView) findViewById(R.id.nav_main_in_route_display_activity);
        navigationView.setTitle("轨迹显示");
...
//                        .fromResource(android.R.drawable.ic_notification_overlay);
    ...
    private void getMediaPoint(List<LatLng> points) {
        ...
        distance = PrivateEncode.GetDistance(maxLat,maxLng,minLat,minLng);
